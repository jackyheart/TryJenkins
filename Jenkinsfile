...
def xcodeproj = 'TryJenkins.xcodeproj' // Path to the xcodeproj
def xcarchive_name = "TryJenkins.xcarchive" // Name of the archive to build
def build_scheme = 'TryJenkins' // Scheme to build the app
def test_scheme = 'TryJenkins' // Scheme to build tests
def simulator_device = 'iPhone 6s' // Name of the device type to use for tests
